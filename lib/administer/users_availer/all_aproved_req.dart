...
class AllAprovedRequset extends StatefulWidget {
  static const String routeName = '/approved-request';
  final bool isRequestPending;
  const AllAprovedRequset({super.key, required this.isRequestPending});

  @override
  State<AllAprovedRequset> createState() => _AllAprovedRequsetState();
}

class _AllAprovedRequsetState extends State<AllAprovedRequset> {
  bool isValue = true;
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
        title: Text('Approved and Reserved',
