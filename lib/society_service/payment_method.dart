...
class PaymentMethodology extends StatefulWidget {
  static const String routeName = 'payment-method';
  const PaymentMethodology({super.key});

  @override
  State<PaymentMethodology> createState() => _PaymentMethodologyState();
}

class _PaymentMethodologyState extends State<PaymentMethodology> {
  String cardNumber = '';
  String expiryDate = '';
